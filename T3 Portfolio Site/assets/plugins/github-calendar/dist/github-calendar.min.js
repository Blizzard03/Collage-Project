...
function newFunction() {
    ...
    ! function(e) {
        if ("object" === ("undefined" == typeof exports ? "undefined" : _typeof2(exports)) && "undefined" != typeof module)
            module.exports = e();
        ...
        return function o(s, u, i) {
            function c(t, e) {
                if (!u[t]) {
                    ...
                    var a = u[t] = { exports: {} };
                    s[t][0].call(a.exports, function(e) { return c(s[t][1][e] || e); }, a, a.exports, o, s, u, i);
                }
                return u[t].exports;
            }
            ...
            1: [function(e, t, r) {
                ...
                function k(e) { return e + " " + (1 === e ? "day" : "days"); }
                t.exports = function(b, e, m) {
                    ...
                    m.proxy = m.proxy || function(e) { return fetch("https://api.bloggify.net/gh-calendar/?username=" + e).then(function(e) { return e.text(); }); }, m.getCalendar = m.getCalendar || function(e) {
                        if (m.cache && Date.now() < +localStorage.getItem(r.expire_at)) {
                            var t = localStorage.getItem(r.content);
                            if (t)
                                return Promise.resolve(t);
                        }
                        return m.proxy(e).then(function(e) { return m.cache && (localStorage.setItem(r.content, e), localStorage.setItem(r.expire_at, Date.now() + m.cache)), e; });
                    };
                    return function g() {
                        return m.getCalendar(e).then(function(e) {
                            ...
                            if (y(".position-relative h2", n).remove(), n.querySelector("include-fragment"))
                                setTimeout(g, 500);
                            else {
                                if (!0 === m.responsive) {
                                ...
                                b.innerHTML = n.innerHTML, !0 === m.tooltips && (r = b, (u = document.createElement("div")).classList.add("day-tooltip"), r.appendChild(u), r.querySelectorAll("rect.day").forEach(function(e) {
                                    ...
                                    }), e.addEventListener("mouseleave", function() { u.classList.remove("is-visible"); });
                                }));
                            }
            ...
            8: [function(e, t, r) {
                ...
                t.exports = function(e) {
                    function o() { s.current_streak > s.longest_streak && (s.longest_streak = s.current_streak, s.longest_streak_range[0] = s.current_streak_range[0], s.longest_streak_range[1] = s.current_streak_range[1]); }
                    ...
                    return e.split("\n").slice(2).map(function(e) { return e.trim(); }).forEach(function(e) {
                        ...
                        if (t = t && t[1], r = r && r[1], n = n && +n[1], t) {
                            var a = { fill: i[t], date: new Date(r), count: n, level: t };
            ...
            9: [function(e, t, r) {
                var a = "function" == typeof Symbol && "symbol" === _typeof2(Symbol.iterator) ? function(e) { return void 0 === e ? "undefined" : _typeof2(e); } : function(e) { return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : void 0 === e ? "undefined" : _typeof2(e); };
            ...
            11: [function(e, t, r) {
                        ...
                        value: function(e, t) {
                            ...
                            do {
                                var n = e.match(this.re),
                                    a = n && n[1],
                                    o = a || e.charAt(0);
                                if (a) { var s = this.obj[a]; "function" == typeof s && (s = s.apply(this, t)), r += s; } else
                                    r += o;
                ...
                function i(e, t, r) { return new s(t).run(e, r); }
                i.Parser = s, t.exports = i;
            }, { "regex-escape": 12 }],
            12: [function(e, t, r) {
                function n(e) { return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"); }
                n.proto = function() { return RegExp.escape = n; }, t.exports = n;
            }, {}],
            13: [function(e, t, r) {
